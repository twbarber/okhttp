...
public final class Cookie {
  ...
  /**
   * Returns the time that this cookie expires. This is {@link Long#MAX_VALUE} if the cookie is not
   * persistent, in which case it will expire at the end of the current session.
   */
   ...
   */
  public static int dateCharacterOffset(String input, int pos, int limit, boolean invert) {
